...
// 12-AUG-2000 ml:
//   small changes 
// 23-JUL-2013 J.Dempster. Minor changes to allow compilation under Delphi XE..XE3
...
begin
  ...
  Result := False ;
  for i := 0 to High(FHeader.ChunkType) do
      if (Byte(FHeader.ChunkType[i]) and Mask) <> (Byte(ChunkType[i]) and Mask) then Result := False ;
