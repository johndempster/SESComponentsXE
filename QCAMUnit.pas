...
//
        ...
        qfmt_last               = 13;
    qcImageFormats : Array[0..qfmt_last-1] of ANSIString = (
                     'Raw (8 bit)',
                     'Raw (16 bit)',
                     'Monochrome (8 bit)',
                     'Monochrome (16 bit)',
...
begin
     ...
     @QCam_CreateCameraSettingsStruct := GetProcAddress(LibraryHnd,'QCam_CreateCameraSettingsStruct') ;
     @QCam_InitializeCameraSettings := GetProcAddress(LibraryHnd,'QCam_InitializeCameraSettings') ;
     @QCam_ReleaseCameraSettingsStruct := GetProcAddress(LibraryHnd,'QCam_ReleaseCameraSettingsStruct') ;
