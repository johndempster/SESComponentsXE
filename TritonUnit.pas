...
begin
     ...
     CalibrationFile :=  SettingsDirectory + TECELLA_CalibrationFileName ;
...
begin
     ...
     CalibrationFile := ExtractFilePath(SettingsDirectory) + TECELLA_CalibrationFileName ;
     ...
     Triton_CheckError( 'tecella_calibrate_save  : ',
                        tecella_calibrate_save ( TecHandle,
                                                 PANSIChar(ANSIString(ExtractFilePath(SettingsDirectory))),
                                                 PANSIChar(ANSIString(TECELLA_CalibrationFileName)) )) ;
     end ;
