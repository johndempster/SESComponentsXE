...
begin
     ...
     try
        ...
        ShowMessage( 'Unable to find Digidata 1200 driver! ') ;
        OK := False ;
        end ;
     ...
     if OK then begin
        if WinRTSetupDMABuffer( DACDev.Handle, DACDMAInfo, LenDMAInfo ) then begin
           ...
           ShowMessage( 'ERROR! Cannot open DAC DMA buffer' ) ;
           OK := False ;
           end ;
        end ;
     ...
     if OK then begin
        try
           ...
           ShowMessage( 'ERROR! Cannot open ADC DMA Device!' ) ;
           OK := False ;
           end ;
        end ;
     ...
     if OK then begin
        ...
        if WinRTSetupDMABuffer(ADCSingleDev.Handle,ADCDMASingleInfo,LenDMAInfo) then
          ...
          ShowMessage( 'ERROR! Cannot open ADC DMA buffer' ) ;
           OK := False ;
           end ;
        end ;
     ...
     if OK then begin
        try
           ...
           ShowMessage('ERROR! Cannot open cyclic ADC DMA Device!' ) ;
           OK := False ;
           end ;
        end ;
     ...
     if OK then begin
        ...
        if WinRTSetupDMABuffer( ADCCyclicDev.Handle, ADCDMACyclicInfo, LenDMAInfo ) then begin
           ...
           ShowMessage( 'ERROR! Cannot open Cyclic ADC DMA buffer') ;
           OK := False ;
           end ;
        end ;
