...
// 29.05.14 JD Buffer empty flags no longer written to framebuffer in StartCapture
...
Tpl_dd_get_info = function(
                   hcam : SmallInt ;
                   bytes : SmallInt ;
                   var text : PANSIChar ) : Word ; stdcall ;
...
var
     ErrCode : SmallInt ;
     ErrMessage : Array[0..255] of ANSIChar ;
     s : String ;
begin
